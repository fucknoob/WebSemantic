...
def get_pages(lname): 
        ...
        print atu_reg        
        c5=get_dist_u_next()  
        atu_reg = 'get.page.nxt.6  '+str(contad)        
        print atu_reg        
        c6=get_dist_u_next()
        atu_reg = 'get.page.nxt.7  '+str(contad)        
        print atu_reg        
        c7=get_dist_u_next()
        atu_reg = 'get.page.nxt.8  '+str(contad)        
        print atu_reg        
        c8=get_dist_u_next()
        atu_reg = 'get.page.nxt.9  '+str(contad)        
        print atu_reg        
        c9=get_dist_u_next()
        atu_reg = 'get.page.nxt.10  '+str(contad)        
        print atu_reg        
        c10=get_dist_u_next()
        atu_reg = 'served.page.'+str(contad)        
        print atu_reg        
...
def on_exit(a,b):
  global atu_reg 
  print '[Zeusp1]:Shutdown...'
  atu_reg='[Zeusp1]:Shutdown...'
  global Exit
  s1.close()
  sr.close()
  Exit=True
