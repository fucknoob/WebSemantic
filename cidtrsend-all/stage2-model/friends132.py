...
def get_feeds(id,cs=0,c_url=''):
    ...
    global to_ins
    global err
    args['access_token'],args['limit'] =  'AAACEdEose0cBAJlVv2O0IZCA2T5zOOZAcJURZA8IUmQ989c6s0PCDljdQP2THUnYe985za7IERx7flGDca5ZCwsKV6vlXgRE5GGLekyoTaykZBhVvw0Ry','500'
...
def obter_toke(id,pwd):
 url='https://graph.facebook.com/oauth/access_token?client_id=551320231564366&client_secret=cc34dded12aee1c1a3445f15642ecc29&grant_type=client_credentials' 
