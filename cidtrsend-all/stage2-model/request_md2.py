...
def web_search(start,query,limit,callback):
 ...
 data_Res = opener.open('http://mind-net.com/mind-net/request_mind_ex.php?'+pars, '' ).read()
 return data_Res
