...
def runc_layer(layer,ex_Data):
    ...
    if True:
       ...
       r=layer
       for s in r.topicos:
         if 'interact.need' in s.dt or 'interaction.comunic.ask.can' in s.dt or 'interact.guess' in s.dt or 'interact.can' in s.dt or 'interact.want' in s.dt :
          class_fnd=True
         if 'object' in s.dt:
          for ds in s.sinapses:
           if 'interact.need' in ds.nr.dt or 'interaction.comunic.ask.can' in ds.nr.dt or 'interact.guess' in ds.nr.dt or 'interact.can' in ds.nr.dt or 'interact.want' in ds.nr.dt :
            class_fnd=True
